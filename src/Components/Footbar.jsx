...
function FootBar() {
    ...
    return ( 
        <div className={`link fixed flex gap-7 justify-between items-center px-3 bottom-1 w-full h-16  ${isDarkMode ?'bg-slate-900': 'bg-white border-2 border-t border-y-0 border-x-0'}`}>
